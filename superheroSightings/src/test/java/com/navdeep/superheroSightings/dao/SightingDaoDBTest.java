...
public class SightingDaoDBTest {
    ...
    public void testGetAllSightings() {
        ...
        testHero2.setSuperPower("test 2 SuperPower");
        ...
        location2 .setLatlong("Test Location 2 latlong");
    ...
    public void testUpdateSighting() {
        ...
        updatedHero.setSuperPower("test upadteHero SuperPower");
    ...
    public void testGetAllSightingByLocation() {
        ...
        testHero2.setDescription("Test Hero 2 Description");
        testHero2.setSuperPower("test Hero 2 SuperPower");
        testHero2.setOrganizations(organizationList);
        testHero2= heroDao.addHero(testHero2);  
